...
class MLazyStackScreen extends StatefulWidget {
  const MLazyStackScreen({super.key});

  @override
  State<MLazyStackScreen> createState() => _MLazyStackScreenState();
}

class _MLazyStackScreenState extends State<MLazyStackScreen> {
