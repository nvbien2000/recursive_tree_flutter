...
class SExpandedScreen extends StatefulWidget {
  ...
  @override
  State<SExpandedScreen> createState() => _SExpandedScreenState();
}

class _SExpandedScreenState extends State<SExpandedScreen> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text("ExpandedWidget (single choice)")),
        body: SafeArea(
          child: Column(
            children: [
              Expanded(
                child: SExpandedWidget(root),
              ),
              divider,
              GridView.count(
